...
export default function JobListings() {
  ...
  const handleSubmitJobPost = async () => {
    try {
      const { title, description, location, salary, category, jobType, isUrgent } = jobPostData;

      // Upload photo file
      const photoName = jobPostData.photo ? jobPostData.photo.name : null;
      ...
      const jobData = {
        ...
        location,
        salary,
        photoName, // Save only the photo name in Firestore
        category,
        jobType,
        isUrgent,
      };
